  ...
  <table border="1" cellspacing="0">
    ...
    <tbody>
        ...
        if(isset($_POST["btnCetak"])){
            ...
            $sql_tampil = "select * from kas_masjid LEFT JOIN categori_sumber ON kas_masjid.categori_sumber_id = categori_sumber.categori_sumber_id LEFT JOIN categori_tujuan ON kas_masjid.categori_tujuan_id = categori_tujuan.categori_tujuan_id where tgl_km BETWEEN '$dt1' AND '$dt2' order by tgl_km asc";
            }
