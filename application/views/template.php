			...
			<div id="sidebar" class="sidebar responsive ace-save-state">
				...
				<ul class="nav nav-list">
					...
					<li class="">
						...
						<ul class="submenu">
							<li class="">
								<a href="<?php echo base_url() ?>Kas_masjid">
									<i class="menu-icon fa fa-caret-right"></i>
									Pemasukan Kas Mesjid
								</a>
								<b class="arrow"></b>
							</li>
							<li class="">
								<a href="<?php echo base_url() ?>Kas_masjid_keluar">
									<i class="menu-icon fa fa-caret-right"></i>
									Pengeluaran Kas Mesjid
								</a>
								<b class="arrow"></b>
							</li>
							<li class="">
								<a href="<?php echo base_url() ?>rekap_kas_masjid">
									<i class="menu-icon fa fa-caret-right"></i>
									Rekap Kas Mesjid
								</a>
								<b class="arrow"></b>
					...
					<?php if ($this->session->userdata('level')==1) { ?>
						...
						<ul class="submenu">
							<li class="">
								<a href="<?php echo base_url() ?>Categori_sumber">
									<i class="menu-icon fa fa-caret-right"></i>
									Sumber Kas
								</a>
								<b class="arrow"></b>
							...
							<li class="">
								<a href="<?php echo base_url() ?>Categori_tujuan">
									<i class="menu-icon fa fa-caret-right"></i>
									Tujuan Kas
								</a>
								<b class="arrow"></b>
				...
				<div class="footer-inner">
					<div class="footer-content">
						<span class="bigger-120">
							<span class="blue bolder">MsRamdan - </span>
