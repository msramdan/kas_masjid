...
class Rekap_kas_masjid_model extends CI_Model
{
    ...
    function get_all()
    {
        ...
        $this->db->select('kas_masjid.*,categori_sumber.nama_categori_sumber,categori_tujuan.nama_categori_tujuan');
        $this->db->from('kas_masjid');
        $this->db->join('categori_sumber', 'categori_sumber.categori_sumber_id = kas_masjid.categori_sumber_id','left');
        $this->db->join('categori_tujuan', 'categori_tujuan.categori_tujuan_id = kas_masjid.categori_tujuan_id','left');
